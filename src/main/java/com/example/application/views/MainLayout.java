 ...
 */
@PWA(name = "sampleProject", shortName = "sampleProject", enableInstallPrompt = false)
@Theme(themeFolder = "sampleproject")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "sampleProject logo"));
        logoLayout.add(new H1("sampleProject"));
